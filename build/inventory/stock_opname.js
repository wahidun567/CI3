...
function BarisBaru(){
	...
	Baris += "<input required type='text' class='form-control col-md' id='jumlah_beli' name='jumlah_beli[]' style='width: 62px; margin: 0 5px;'><input type='hidden' id='id_barang' name='id_barang[]' /> <input type='hidden' id='id_varian_harga' name='id_varian_harga[]' /><input type='hidden' id='harga_jual' name='harga_jual[]' /><input type='hidden' id='stok_min' name='stok_min[]' /><input type='hidden' id='batch_no' name='batch_no[]' value='"+batch+"'/>";
