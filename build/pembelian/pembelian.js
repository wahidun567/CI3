...
$(document).ready(function() {
        ...
        "ajax": {
            "url":  linke+"Pembelian_bpb/ajax_list",
            "type": "POST"
        },
...
function pilihDataBpb(notrans2, kode_supplier2, nama2, coly2,biaya_ekspedisi2, no_faktur_supplier2){
		console.log("notrans"+notrans2);
	    document.getElementById('notrans'+mdl).value = notrans2;
		document.getElementById('kode_supplier'+mdl).value = kode_supplier2;
		document.getElementById('nama'+mdl).value = nama2;
		document.getElementById('coly'+mdl).value = coly2;
		document.getElementById('biaya_ekspedisi'+mdl).value = biaya_ekspedisi2;
		document.getElementById('no_faktur_supplier'+mdl).value = no_faktur_supplier2;
		$('#ModalPembelian'+mdl).modal('hide');
}
