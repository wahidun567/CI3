...
$("#filter_all").click(function () {
       var url=linke+"Laporan/get_hutang_pembelian/";
       var tgl_1=$("#tgl_1").val();
       var tgl_2=$("#tgl_2").val();
       if (tgl_1 != "" && tgl_2!="") {
         //console.log(url+"?tgl_1="+tgl_1+"&tgl_2="+tgl_2);
              $('#table').bootstrapTable('refresh', {url: linke+'Laporan/get_hutang_pembelian/' + tgl_1 + '/' + tgl_2});
              saldo_asli = 0;
       }else {
...
function runningFormatter(value, row, index) {
 ...
 function nota_jalan(){
     ...
     //   console.log('penjualan/print_rugi_laba_salesman/'+tgl_1+'/'+tgl_2);
        $('#area-1').load(linke+'Laporan/print_hutang_pembelian/'+tgl_1+'/'+tgl_2, function() {
          printDiv('area-1');
